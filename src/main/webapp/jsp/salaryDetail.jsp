...
<body>
	...
	<a class="easyui-linkbutton" href="javascript:void(0)"  onclick="postDetails()">提交</a>
</body>
<script type="text/javascript">
  var json;
	 window.onload = function() {
		...
		for(x in s){
			...
			var t='';		 
			 ...
			 t=t+'<td><input class="easyui-validatebox"  placeholder="请输入奖励金额" id="bonus'+s[x].num+'" type="text"></td>'
			 +'<td><input class="easyui-validatebox"   placeholder="请输入应扣金额" id="reduction'+s[x].num+'" type="text"></td>'
